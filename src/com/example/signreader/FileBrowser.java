...
//import cn.itcreator.android.reader.HtmlBrowser;
import com.example.signreader.IconText;
import com.example.signreader.IconTextListAdapter;
//import com.example.signreader.PictureBrowser;
//import cn.itcreator.android.reader.R;
//import cn.itcreator.android.reader.UMDBrowser;
//import cn.itcreator.android.reader.FileBrowser.DISPLAYMODE;
...
public class FileBrowser extends ListActivity {
	...
	Handler handler=new Handler(){
		...
		public void handleMessage(Message msg){
			if(msg.what==0x126)
			{
				Toast.makeText(getApplicationContext(), String.valueOf(text_length), Toast.LENGTH_LONG).show();
			}
		}
	};
		...
		if (selectedFileString.equals(getString(R.string.current_dir))) {
			...
			case RELATIVE:
				...
				if (file.isFile()) {
					...
					if (checkEnds(filePath, getResources().getStringArray(
							R.array.textEnds))) {
						text_length = CalTextLength(filePath);
			...
			case ABSOLUTE:
				...
				if (file.isFile()) {
					...
					if (checkEnds(Constant.FILE_PATH, getResources()
						...
						text_length = CalTextLength(Constant.FILE_PATH);
						handler.sendEmptyMessage(0x126);
						/*
						setProgressBarIndeterminateVisibility(false);
...
//						i.setClass(getApplicationContext(), TxtActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(1, EXIT, 1, "Exit").setShortcut('3', 'a').setIcon(
				R.drawable.close);
		menu.add(1, CIRC_SCREEN, 0, "Gyrate")
...
/*
	...
	*/
	...
	private Integer CalTextLength(String filepath)
	{
		int text_len = 0;
		int length = 0;
		String res="";   
