...
public class BookShelfActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rtTop = (Button)findViewById(R.id.btn_rightTop);
        ...
        rtTop.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(BookShelfActivity.this, FileBrowser.class);
    ...
    private String[] getAllBooks()
    {
        ...
        booklist = bookoperations.getAllClasses();
        Book bookitem;
        int length = booklist.size();
        String[] booknames;
        booknames= new String[length];
        for(int i=0;i<length;i++)
        {
        	bookitem = booklist.get(i);
        	booknames[i] = bookitem.getName();
        }
        return booknames;
    ...
    class ShlefAdapter extends BaseAdapter{
		...
		public View getView(int position, View contentView, ViewGroup arg2) {
			...
			if(data.length>position){
				if(position<booktitle.length){
				   view.setText(booktitle[position]);
				}
